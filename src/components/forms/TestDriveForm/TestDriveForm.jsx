    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            setSubmitError(
                getServerErrorMessage(
                    error,
                    "Unable to book the test drive. Please try again."
                )
            );
        } finally {
            setSubmitting(false);
